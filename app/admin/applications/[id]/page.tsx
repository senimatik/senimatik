            ...
            <header className="flex items-center justify-between">
                ...
                {isReviewed && (
                    <div className="flex items-center gap-4">
                        <span className={`px-4 py-2 rounded font-pixel text-[10px] uppercase tracking-widest ${application.status === "approved"
            ...
            <section className="p-12 border border-zinc-100 rounded-[48px] bg-white space-y-16 shadow-2xl shadow-black/2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div className="space-y-8">
                        <div className="space-y-3">
                            <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">Artist Statement</h3>
                            <p className="text-base font-light leading-relaxed text-zinc-600 italic">&quot;{application.artistStatement}&quot;</p>
                        </div>

                        <div className="space-y-3">
                            <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">External Relays</h3>
                    ...
                    <div className="space-y-8">
                        ...
                        {!isReviewed && (
                            <div className="space-y-3">
                                <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">Review Note (optional)</h3>
                                <textarea
                                    rows={4}
                                    value={reviewNote}
                        ...
                        {isReviewed && application.status === "approved" && (
                            <div className="space-y-3">
                                <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">Revocation Reason (optional)</h3>
                                <textarea
                                    rows={4}
                                    value={reviewNote}
                                    onChange={(e) => setReviewNote(e.target.value)}
                        ...
                        {isReviewed && application.reviewNote && (
                            <div className="space-y-3">
                                <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">Review Note</h3>
                        ...
                        {application.user && (
                            <div className="space-y-3">
                                <h3 className="text-[10px] font-pixel uppercase tracking-widest text-zinc-400">Account Info</h3>
                ...
                <div className="pt-12 border-t border-zinc-100 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-pixel uppercase tracking-widest text-zinc-400">
