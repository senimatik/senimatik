    ...
    <main className="min-h-screen bg-background-2 text-white flex flex-col items-center justify-center px-4">
      <div className="max-w-sm w-full space-y-8 text-center">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-medium">Unauthorized</h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            href="/"
            className="w-full inline-flex items-center justify-center rounded-md border bg-white px-4 py-2.5 text-sm font-medium text-black hover:text-primary transition-colors"
          >
            Go home
          </Link>
        </div>
